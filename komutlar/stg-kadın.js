...
if(!['801197463485677598'].some(role => message.member.roles.cache.get(role)) && !message.member.hasPermission('ADMINISTRATOR')) 
...
const tag = '♰'   
const kadınrol = message.guild.roles.cache.find(r => r.id === '801197465080168448') 
const kayıtsız = message.guild.roles.cache.find(r => r.id === '801197466623803432')
const genelchat = message.guild.channels.cache.find(c => c.id === '801197567105826857')
const savelog = message.guild.channels.cache.find(c => c.id === '801378931910901845')
