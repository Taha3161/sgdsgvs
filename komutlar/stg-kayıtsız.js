...
if(!['801127054879490159'].some(role => message.member.roles.cache.get(role)) && !message.member.hasPermission('ADMINISTRATOR')) 
...
await member.roles.add('801197466623803432')
